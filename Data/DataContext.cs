...
namespace SmartSchollAPI.Data
{
    public class DataContext : DbContext
    {
        //Construtor para herdar a string de conexão
        ...
        {
            //Mapeamento entre Aluno e Disciplina (Muitos pra Muitos)
            builder.Entity<AlunoDisciplina>()
                .HasKey(AD => new { AD.AlunoId, AD.DisciplinaId });

            //Mapeamento entre Aluno e Curso (Muitos pra Muitos)
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("05/01/2005")),
                    new Aluno(2, 2, "Paula", "Isabela", "3354288", DateTime.Parse("05/02/2005")),
                    new Aluno(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("05/03/2005")),
                    new Aluno(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("05/04/2005")),
                    new Aluno(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse("05/05/2005")),
                    new Aluno(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse("05/06/2005")),
